...
export type { OutsiderLevel as OutsideStoryLevel } from '@core/domain/game';

import { BaseGameEngine } from './BaseGameEngine';
import type { LevelModule } from './BaseGameEngine';

// Import domain services
import { outsideStoryRepository as levelRepository, OUTSIDE_STORY_ERROR_LEVEL as ERROR_LEVEL } from '@core/domain/game';
import type { OutsiderLevel } from '@core/domain/game';
