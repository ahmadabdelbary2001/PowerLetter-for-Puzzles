...
import { useOutsideStory, type UseOutsideStoryResult } from "@powerletter/core";
...
const OutsideStoryGame: React.FC<UseOutsideStoryResult> = (game) => {
  const { notification, onClearNotification, handleBackWith, t, instructions } =
    game;
