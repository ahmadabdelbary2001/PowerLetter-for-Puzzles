            ...
            {kidsGames.map((type) => (
              <Card
                ...
                className={cn(
                  ...
                  gameType === type.id && type.status === 'available' && 'ring-2 ring-green-500/50 bg-green-500/5 dark:bg-green-500/10'
                )}
                onClick={() => type.status === 'available' && handleGameSelect(type.id)}
              >
                ...
                <CardContent>
                  <div className="space-y-4">
                    ...
                    >
                      {type.status === 'available' ? t.playNow : t.comingSoon}
                      {type.status !== 'available' && <Lock className="w-4 h-4 ml-2" />}
                    </Button>
                  </div>
                </CardContent>
              </Card>
